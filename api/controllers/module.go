...
// URLMapping ...
func (c *ModuleController) URLMapping() {
...
// @Success 201 {int} models.Module
// @Failure 403 body is empty
// @router / [post]
func (c *ModuleController) Post() {
	var v models.Module
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddModule(&v); err == nil {
...
// @router /:id [get]
func (c *ModuleController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *ModuleController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ModuleController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
